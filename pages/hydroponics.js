                ...
                <button
                  className={
                    questions.indexOf(currentQuestion) == 0
                      ? "hidden py-4 font-bold text-white bg-plantDark rounded-full motion-safe:hover:scale-110"
                      : "px-6 mx-2 py-4 font-bold text-white bg-plantDark rounded-full motion-safe:hover:scale-110"
                  }
